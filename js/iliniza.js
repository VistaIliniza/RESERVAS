// =========================================
// ILINIZA.JS - LÓGICA DE OVERLAP AVANZADA Y ALERTA VISUAL DE RECAMBIO
// =========================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function cargarReservas() {
        try {
            ...
            const reservasCabaña = datos.filter(reserva => String(reserva.cabana).toLowerCase().includes("iliniza"));
    ...
    formReserva.addEventListener('submit', async (e) => {
        ...
        const reservaData = {
            ...
            celular: celular, cabana: "Vista Iliniza", ingreso: checkinDateStr, salida: checkoutDateStr
        };
