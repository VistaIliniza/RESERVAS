// =========================================
// COTOPAXI.JS - DETECCIÓN DE FECHAS OCUPADAS AL TOCAR
// =========================================
    ...
    function renderCalendar() {
        ...
        for (let i = 1; i <= daysInMonth; i++) {
            ...
            if (fechasOcupadas.includes(dateString)) {
                ...
                // Evento funcional en computadoras y celulares al presionar la fecha roja
                dayDiv.addEventListener('click', () => {
                    const datosCliente = infoFechasOcupadas[dateString];
                    
                    // MEJORA: Protección preventiva por si faltan datos en la celda de Excel
    ...
    async function cargarReservas() {
        try {
            ...
            const reservasCabaña = datos.filter(reserva => 
                String(reserva.cabana).toLowerCase().includes("cotopaxi")
            );
